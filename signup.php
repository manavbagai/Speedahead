...
<img src="images/register.gif" height="300" width="300">
		...
		<form action="signup.php" method="post">
			...
			Username
			<div class="name1"><input type="text" name="username"></div>
			<br><br>
			Password
			<div class="name2"><input type="password" name="password" cols="20"></div>
			<br><br>
			Email    
			<div class="name3"><input type="text" cols="20" name="email" ></div>
			<br><br>
			Phone Number 
			<div class="name4"><input type="text" cols="20" name="Phone"></div>
			<br><br>
